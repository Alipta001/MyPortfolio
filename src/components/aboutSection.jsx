      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            <div className="hidden md:block absolute -bottom-4 -right-4 w-full h-full border-2 border-cyan-500/20 rounded-[3rem] z-0" />
            
            <div className="absolute bottom-2 left-6 md:left-10 z-20 bg-white/5 backdrop-blur-2xl border border-white/10 p-5 md:p-6 rounded-2xl shadow-2xl">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <p className="text-gray-300 font-normal leading-relaxed text-sm md:text-base max-w-xl">
                As a developer specializing in <strong className="text-white font-semibold">MongoDB, Express, React, and Node.js</strong>, 
                ...
                <strong className="text-white font-semibold"> Zingo</strong> and <strong className="text-white font-semibold">DocReserve</strong>.
              </p>

              {/* Stats Grid - Fixed for Visibility */}
              <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/10">
                <div>
                  <h4 className="text-cyan-500 font-bold uppercase tracking-[0.2em] text-[11px] mb-3">
                    Current Stack
                  </h4>
